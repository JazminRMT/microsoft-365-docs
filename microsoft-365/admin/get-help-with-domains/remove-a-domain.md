...
in the M365 portal you can go to settings --> Domains --> Select the domain --> Remove Domain and then select --> automatically remove (it says it make take up to 24h to complete)
